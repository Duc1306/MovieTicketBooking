...
const HeroSection = () => {
  return (
    <div class='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
      <img
        alt=""
      ...
      <button class="flex items-center gap-1 px-6 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer">
        Explore Movies
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
